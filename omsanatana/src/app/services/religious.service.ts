...
export class ReligiousService {
  ...
  maincategeoriesbyid(_id: string):Observable<any>{
    return this.httpClient.get(URL+"maincategory/"+_id+"/")

  }



  categeoriesbyid(_id: string):Observable<any>{
    return this.httpClient.get(URL+"category/"+_id+"/")

  }

  subcategeoriesbyid(_id: string):Observable<any>{
